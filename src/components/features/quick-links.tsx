        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {links.map((link) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-navy-800 group-hover:text-navy-800 transition-colors">
                {link.title}
              </h3>
              <p className="mt-2 text-sm text-key/70">{link.description}</p>
              <div className="mt-4 inline-flex items-center text-sm font-semibold text-navy-800 underline decoration-2 underline-offset-2">
                Learn more
                <svg
